...
Component.prototype.createOperations = function()
{
    ...
    if (installer.isInstaller()) {
        ...
        component.addOperation("Execute", "{0,5100}", "@TargetDir@/bin/vcredist_x64_2010.exe", "/passive", "/norestart")
    }
    ...
    if (installer.isUpdater()) {
        component.addOperation("Execute", "{0,5100}", "@TargetDir@/bin/vcredist_x64_2010.exe", "/norestart", "/q")
    }
}
